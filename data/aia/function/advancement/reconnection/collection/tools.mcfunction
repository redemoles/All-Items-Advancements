...
#> aia:in_game/players_settings/reconnect/advancement/collection/tools
#
...
execute if entity @p[tag=aia.temp,advancements={aia:tools/copper_axe=false}] if score @s aia.data.item.copper_axe matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/copper_axe
execute if entity @p[tag=aia.temp,advancements={aia:tools/copper_boots=false}] if score @s aia.data.item.copper_boots matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/copper_boots
execute if entity @p[tag=aia.temp,advancements={aia:tools/copper_chestplate=false}] if score @s aia.data.item.copper_chestplate matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/copper_chestplate
execute if entity @p[tag=aia.temp,advancements={aia:tools/copper_helmet=false}] if score @s aia.data.item.copper_helmet matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/copper_helmet
...
execute if entity @p[tag=aia.temp,advancements={aia:tools/diamond_boots=false}] if score @s aia.data.item.diamond_boots matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/diamond_boots
execute if entity @p[tag=aia.temp,advancements={aia:tools/diamond_chestplate=false}] if score @s aia.data.item.diamond_chestplate matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/diamond_chestplate
execute if entity @p[tag=aia.temp,advancements={aia:tools/diamond_helmet=false}] if score @s aia.data.item.diamond_helmet matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/diamond_helmet
...
execute if entity @p[tag=aia.temp,advancements={aia:tools/golden_boots=false}] if score @s aia.data.item.golden_boots matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/golden_boots
execute if entity @p[tag=aia.temp,advancements={aia:tools/golden_chestplate=false}] if score @s aia.data.item.golden_chestplate matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/golden_chestplate
execute if entity @p[tag=aia.temp,advancements={aia:tools/golden_helmet=false}] if score @s aia.data.item.golden_helmet matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/golden_helmet
...
execute if entity @p[tag=aia.temp,advancements={aia:tools/iron_boots=false}] if score @s aia.data.item.iron_boots matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/iron_boots
execute if entity @p[tag=aia.temp,advancements={aia:tools/iron_chestplate=false}] if score @s aia.data.item.iron_chestplate matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/iron_chestplate
execute if entity @p[tag=aia.temp,advancements={aia:tools/iron_helmet=false}] if score @s aia.data.item.iron_helmet matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/iron_helmet
...
execute if entity @p[tag=aia.temp,advancements={aia:tools/chainmail_chestplate=false}] if score @s aia.data.item.chainmail_chestplate matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/chainmail_chestplate
execute if entity @p[tag=aia.temp,advancements={aia:tools/chainmail_helmet=false}] if score @s aia.data.item.chainmail_helmet matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/chainmail_helmet
execute if entity @p[tag=aia.temp,advancements={aia:tools/chainmail_leggings=false}] if score @s aia.data.item.chainmail_leggings matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/chainmail_leggings
execute if entity @p[tag=aia.temp,advancements={aia:tools/stone_axe=false}] if score @s aia.data.item.stone_axe matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/stone_axe
...
execute if entity @p[tag=aia.temp,advancements={aia:tools/leather_chestplate=false}] if score @s aia.data.item.leather_chestplate matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/leather_chestplate
execute if entity @p[tag=aia.temp,advancements={aia:tools/leather_helmet=false}] if score @s aia.data.item.leather_helmet matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/leather_helmet
execute if entity @p[tag=aia.temp,advancements={aia:tools/leather_horse_armor=false}] if score @s aia.data.item.leather_horse_armor matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/leather_horse_armor
execute if entity @p[tag=aia.temp,advancements={aia:tools/leather_leggings=false}] if score @s aia.data.item.leather_leggings matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/leather_leggings
execute if entity @p[tag=aia.temp,advancements={aia:tools/wooden_axe=false}] if score @s aia.data.item.wooden_axe matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/wooden_axe
...
execute if entity @p[tag=aia.temp,advancements={aia:tools/brush=false}] if score @s aia.data.item.brush matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/brush
execute if entity @p[tag=aia.temp,advancements={aia:tools/carrot_on_a_stick=false}] if score @s aia.data.item.carrot_on_a_stick matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/carrot_on_a_stick
execute if entity @p[tag=aia.temp,advancements={aia:tools/clock=false}] if score @s aia.data.item.clock matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/clock
execute if entity @p[tag=aia.temp,advancements={aia:tools/compass=false}] if score @s aia.data.item.compass matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/compass
execute if entity @p[tag=aia.temp,advancements={aia:tools/crossbow=false}] if score @s aia.data.item.crossbow matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/crossbow
execute if entity @p[tag=aia.temp,advancements={aia:tools/elytra=false}] if score @s aia.data.item.elytra matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/elytra
execute if entity @p[tag=aia.temp,advancements={aia:tools/fishing_rod=false}] if score @s aia.data.item.fishing_rod matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/fishing_rod
execute if entity @p[tag=aia.temp,advancements={aia:tools/flint_and_steel=false}] if score @s aia.data.item.flint_and_steel matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/flint_and_steel
execute if entity @p[tag=aia.temp,advancements={aia:tools/mace=false}] if score @s aia.data.item.mace matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/mace
execute if entity @p[tag=aia.temp,advancements={aia:tools/recovery_compass=false}] if score @s aia.data.item.recovery_compass matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/recovery_compass
execute if entity @p[tag=aia.temp,advancements={aia:tools/saddle=false}] if score @s aia.data.item.saddle matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/saddle
execute if entity @p[tag=aia.temp,advancements={aia:tools/shears=false}] if score @s aia.data.item.shears matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/shears
execute if entity @p[tag=aia.temp,advancements={aia:tools/shield=false}] if score @s aia.data.item.shield matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/shield
execute if entity @p[tag=aia.temp,advancements={aia:tools/spyglass=false}] if score @s aia.data.item.spyglass matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/spyglass
execute if entity @p[tag=aia.temp,advancements={aia:tools/totem_of_undying=false}] if score @s aia.data.item.totem_of_undying matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/totem_of_undying
execute if entity @p[tag=aia.temp,advancements={aia:tools/trident=false}] if score @s aia.data.item.trident matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/trident
execute if entity @p[tag=aia.temp,advancements={aia:tools/warped_fungus_on_a_stick=false}] if score @s aia.data.item.warped_fungus_on_a_stick matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/warped_fungus_on_a_stick
execute if entity @p[tag=aia.temp,advancements={aia:tools/wolf_armor=false}] if score @s aia.data.item.wolf_armor matches 1 run advancement grant @p[tag=aia.temp] only aia:tools/wolf_armor

scoreboard players operation @p[tag=aia.temp] aia.data.collection.tools.count = @s aia.data.collection.tools.count
