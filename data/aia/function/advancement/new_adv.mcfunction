...
tag @s add aia.temp
execute in aia:lobby as @e[type=marker,tag=aia.marker,distance=0..,predicate=aia:id_team] run function aia:advancement/new_adv_score with storage aia:temp item
