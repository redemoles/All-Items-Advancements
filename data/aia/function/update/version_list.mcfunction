...
execute if score #last_update aia.data.update matches 26020 run function aia:update/2026/3/0

tellraw @a [{"text":"\n[","color":"#6F6F6F"},{"text":"All Items ","color":"#F9F9F9"},{"text":"Advancements ","color":"#3FB7FF"},{"text":"26.3.0","color":"#FFE73F"},{"text":"]"},{"text":" Datapack updated!","color":"#FFFFFF"}]
