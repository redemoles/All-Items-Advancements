...
execute if score #pause aia.data.temp matches 0 run gamerule minecraft:advance_time true
execute if score #pause aia.data.temp matches 0 run gamerule minecraft:advance_weather true
...
execute if score #pause aia.data.temp matches 1 run gamerule minecraft:advance_time false
execute if score #pause aia.data.temp matches 1 run gamerule minecraft:advance_weather false
